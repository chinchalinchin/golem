...
Would you like me to append this table to the new `docs/field_guide.md`, and then proceed with updating the `README.md` architecture section to reflect the new dynamic model naming schema we built?